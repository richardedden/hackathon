function [out_v1 out_v2] = diff_align2(vector1, vector2, range)
...
%figure(98)
for phase=1:20
    vec2=real(vect2*exp(1i*pi/180*(10-10)));
for ii=1:21
...
out_v1=vector1;
out_v2=circshift(vector2*exp(1i*pi/180*(10-10)),[1 index_vec(index2)-11]);
end